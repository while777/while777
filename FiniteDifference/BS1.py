...
def brennan_schwartz(r0, theta0, a, b, sigma, rho, y, T = 0.25, N = 2, seed = 777):
    np.random.seed(seed)
    dt = T / float(N)
    rates = [r0]
    thetas = [theta0]
...
y = np.dot(L, r)
z = brennan_schwartz(0.02, 0.05, [0, 0.05], [0, 0.01, 0.1], [0.1, 0.05], 0.3, y, T = 0.25, N = 2, seed = 777)
x = z[1]
